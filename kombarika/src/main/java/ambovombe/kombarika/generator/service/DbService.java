...
public class DbService {
    ...
    // AZA FAFANA
    // public static void getPrimaryKey(Connection con, String tableName) throws
    // Exception{
    //// HashMap<String, String> map = new HashMap<>();
    //
    // String query = "SELECT * FROM "+tableName;
    ...
    // ResultSet tablesRs = meta.getTables(null, null, tableName, new
    // String[]{"TABLE"});
    ...
    //// for(int i = 1; i <= count; i++){
    // System.out.println(" column NAME = " + rsmd.getColumnName(4) + " column
    // VALUES = "+primaryKeys.getObject("column_name") + " column TYPE = " +
    // rsmd.getColumnClassName(4));
    //// }
    // }
    // }
    ...
    // public static void getForeignKeys(Connection con, String tableName) throws
    // Exception{
    // String query = "SELECT * FROM "+tableName;
    // DatabaseMetaData meta = con.getMetaData();
    // ResultSet tablesRs = meta.getTables(null, null, tableName, new
    ...
    // System.out.println(" column NAME = " + rsmd2.getColumnName(i) + " column
    // VALUES = " + foreignKeys.getString(i) + " column TYPE =
    // "+rsmd2.getColumnClassName(i));
    // }
    // System.out.println("-------------------------------------");
    // }
    // // return map;
